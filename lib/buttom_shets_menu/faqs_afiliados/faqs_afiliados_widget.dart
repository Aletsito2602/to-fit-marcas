...
import 'faqs_afiliados_model.dart';
export 'faqs_afiliados_model.dart';

class FaqsAfiliadosWidget extends StatefulWidget {
  const FaqsAfiliadosWidget({super.key});

  @override
  State<FaqsAfiliadosWidget> createState() => _FaqsAfiliadosWidgetState();
}

class _FaqsAfiliadosWidgetState extends State<FaqsAfiliadosWidget> {
  late FaqsAfiliadosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FaqsAfiliadosModel());
