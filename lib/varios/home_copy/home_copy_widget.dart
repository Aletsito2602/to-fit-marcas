...
import '/home_slide/slide/slide_widget.dart';
import 'dart:ui';
...
class _HomeCopyWidgetState extends State<HomeCopyWidget>
  ...
  void initState() {
    ...
    animationsMap.addAll({
      'swipeableStackOnPageLoadAnimation1': AnimationInfo(
      ...
      'swipeableStackOnPageLoadAnimation2': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        effectsBuilder: () => [
          MoveEffect(
            curve: Curves.easeInOut,
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(0.0, 8.0, 15.0, 8.0),
              child: Container(
                width: 40.0,
                height: 79.11,
                              ...
                              return FlutterFlowSwipeableStack(
                                ...
                                itemBuilder: (context, swipeableStackIndex) {
                                  ...
                                  return Container(
                                    ...
                                    child: SlideWidget(
                                      key: Key(
                                          'Keyo3q_${swipeableStackIndex}_of_${swipeableStackPostsRecordList.length}'),
                                      posts:
                                          swipeableStackPostsRecord.reference,
                                    ),
                                  );
                                },
                                ...
                                cardDisplayCount: 12,
                                scale: 1.03,
                                backCardOffset: const Offset(120.0, 10.0),
                              ).animateOnPageLoad(animationsMap[
                                  'swipeableStackOnPageLoadAnimation1']!);
                            },
                          ),
                          StreamBuilder<List<PostsRecord>>(
                            stream: queryPostsRecord(),
                            builder: (context, snapshot) {
                              ...
                              return FlutterFlowSwipeableStack(
                                ...
                                allowedSwipeDirection:
                                  ...
                                  'swipeableStackOnPageLoadAnimation2']!);
                            },
                          ),
                        ],
                      ),
