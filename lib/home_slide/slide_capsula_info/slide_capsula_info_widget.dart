...
import 'slide_capsula_info_model.dart';
export 'slide_capsula_info_model.dart';

class SlideCapsulaInfoWidget extends StatefulWidget {
  const SlideCapsulaInfoWidget({
    super.key,
    this.posts,
  });
  ...
  @override
  State<SlideCapsulaInfoWidget> createState() => _SlideCapsulaInfoWidgetState();
}

class _SlideCapsulaInfoWidgetState extends State<SlideCapsulaInfoWidget> {
  late SlideCapsulaInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SlideCapsulaInfoModel());
