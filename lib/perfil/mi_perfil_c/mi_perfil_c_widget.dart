...
import 'mi_perfil_c_model.dart';
export 'mi_perfil_c_model.dart';

class MiPerfilCWidget extends StatefulWidget {
  const MiPerfilCWidget({super.key});

  @override
  State<MiPerfilCWidget> createState() => _MiPerfilCWidgetState();
}

class _MiPerfilCWidgetState extends State<MiPerfilCWidget>
    with TickerProviderStateMixin {
  late MiPerfilCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MiPerfilCModel());
                      ...
                      child: Row(
                        ...
                        children: [
                          AuthUserStreamWidget(
                            builder: (context) => Text(
                              valueOrDefault<String>(
                                valueOrDefault(currentUserDocument?.alias, ''),
                                '@eligetualias',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .headlineMedium
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              context
                                  .pushNamed(EditarPerfilPageWidget.routeName);
                            },
                            text: 'Editar Perfil',
                                                                          ...
                                                                          if (!gridViewProductosRecord
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: InkWell(
                                                                                ...
                                                                                onTap: () async {
                                                                                  await gridViewProductosRecord.reference.update({
                                                                                    ...mapToFirestore(
                                                                                      {
