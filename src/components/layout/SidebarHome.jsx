...
const SidebarHome = ({ onClose }) => {
  ...
  return (
    <div className="flex flex-col h-full border-2 bg-black shadow-2xl border-white flex-shrink-0" 
         style={{ 
           width: '240px',
           minWidth: '240px',
           maxWidth: '240px',
      ...
      {/* Logo Section */}
      <div className="pt-16 pb-12 px-6 flex justify-center flex-shrink-0" style={{ height: '140px' }}>
      ...
      {/* Barra de búsqueda */}
      <div className="px-8 mb-10 flex-shrink-0" style={{ height: '80px' }}>
      ...
      <nav className="px-6 flex flex-col justify-center flex-shrink-0" style={{ height: '400px' }}>
          ...
          {navigationItems.map((item) => {
            ...
            return (
              <NavLink
                ...
                style={{ height: '64px', minHeight: '64px', fontFamily: 'Poppins, sans-serif' }}
              >
      ...
      <div className="px-8 pb-10 flex-shrink-0" style={{ height: '120px' }}>
